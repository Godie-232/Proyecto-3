...
boton10 = Button(panel,text = '10)Acerca de',width=30, height = 2,command = boton9).place(x=350,y=600)
boton11 = Button(panel,text = '11)Salir',width=30, height = 2,command = boton9).place(x=350,y=650)
